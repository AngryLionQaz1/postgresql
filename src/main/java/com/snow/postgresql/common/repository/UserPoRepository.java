...
@Repository
public interface UserPoRepository extends JpaRepository<UserPo, String> {
    /**
     ...
     */
//    @Query(value = "SELECT u FROM UserPo u WHERE name=:name")
//    UserPo findName(@Param("name") String name);
     ...
     * 根据用户名查询
     */
//    @Query("select t from UserPo t where t.name = :name")
//    UserPo findByUserName(@Param("name") String name);

    /**
     * 查询全部
     */
    @Query("select t from UserPo t")
    List<UserPo> find();
    ...
    @Modifying
    @Transactional
    @Query("delete from UserPo u where u.id=:id")
     ...
     * @param o 字段参数
     */
//    List<UserPo> findByHql(String tableName, String filed, Object o);
//
//    Object findObjiectByHql(String tableName, String filed, Object o);
     ...
     */
//    List<UserPo> findByMoreFiled(String tableName, LinkedHashMap<String, Object> map);
     ...
     */
//    List<UserPo> findByMoreFiledPage(String tableName, LinkedHashMap<String, Object> map,
//                                   int star, int pageNumber);
     ...
     */
//    List<UserPo> findPages(String tableName, String filed, Object o, int start, int pageNumber);
